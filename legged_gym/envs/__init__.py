...
# ===== Panda tasks (reuse Go2 task logic with Panda assets and PD gains) =====
from legged_gym.envs.Panda import (
    PandaBackFlip,
    PandaBackFlipCfg,
    PandaBackFlipCfgPPO,
    PandaHandstand,
...
task_registry.register("panda_handstand", PandaHandstand, PandaHandstandCfg(), PandaHandstandCfgPPO())
task_registry.register("panda_leggedstand", PandaLeggedstand, PandaLeggedstandCfg(), PandaLeggedstandCfgPPO())
task_registry.register("panda_jump", PandaJump, PandaJumpCfg(), PandaJumpCfgPPO())
task_registry.register("panda_spring_jump", PandaSpringJump, PandaSpringJumpCfg(), PandaSpringJumpCfgPPO())
task_registry.register("panda_backflip", PandaBackFlip, PandaBackFlipCfg(), PandaBackFlipCfgPPO())
